...
const Logo = forwardRef(({ disabledLink = false, isSmall = false, sx, ...other }, ref) => {
  ...
  //       <text y="75%" fontSize="28px" fontWeight="bold" fontFamily="Arial, sans-serif">
  //         <tspan fill={PRIMARY_DARK}>Visa</tspan>
  //         <tspan fill={PRIMARY_MAIN}>Lelo</tspan>
  //       </text>
  //     </svg>
  //   </Box>
  // );
